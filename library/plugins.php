...
/*
GearWorks Plugins & Extra Functionality
Author: Eddie Machado with modifications by Cristina Robinson
...
function bones_get_socialimage() {
  ...
  if(empty($socialimg)) {
	$socialimg = get_template_directory_uri() . '/screenshot.png';
  }
  return $socialimg;
}
...
function bones_google_header() {
	if (is_singular()) {
		...
		echo '<meta itemprop="description" content="' .strip_tags( get_bloginfo("description") ).'">' . "\n";
